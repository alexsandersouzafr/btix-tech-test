...
export default function PostPreview({ post, user }) {
  return (
    <Link href={`post/${post.id - 1}`}>
      <div className="text-zinc-900 lg:max-w-xs p-4 m-2 md:m-0 border border-zinc-400 hover:shadow-2xl shadow-lg hover:bg-zinc-200 cursor-pointer transition-all">
